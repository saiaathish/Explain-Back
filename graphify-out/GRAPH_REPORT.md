...
Cohesion: 0.17
Nodes (11): Architecture, Current evidence, Decision, Dual-model CI outcome, Measurements and retained tuning, Next acceptance run, Passing evidence, Production status (+3 more)
