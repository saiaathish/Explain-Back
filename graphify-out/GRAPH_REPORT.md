...
## Corpus Check
- 53 files · ~30,234 words
- Verdict: corpus is large enough that graph structure adds value.

## Summary
- 387 nodes · 743 edges · 34 communities (25 shown, 9 thin omitted)
- Extraction: 98% EXTRACTED · 2% INFERRED · 0% AMBIGUOUS · INFERRED: 14 edges (avg confidence: 0.8)
- Token cost: 0 input · 0 output

## Graph Freshness
- Built from commit: `3c4ab65a`
...
- `test_concept_anchor_must_be_verbatim()` --calls--> `locate_concept_anchors()`  [EXTRACTED]
  tests/test_extract.py → backend/extract.py
- `run()` --calls--> `active_model()`  [EXTRACTED]
  tests/diagnose_misses.py → backend/llm.py
...
### Community 3 - "main.py"
Cohesion: 0.10
Nodes (38): align(), _concept_vector_key(), embed(), embed_concepts(), _embedding_model(), compute_coverage(), lifespan(), rate_limit_analyze() (+30 more)
...
Cohesion: 0.18
Nodes (21): _certainty(), _dedupe_overlaps(), extract_concepts(), locate_concept_anchors(), locate_spans(), Any, _type(), best_flag() (+13 more)
...
### Community 24 - "embed"
Cohesion: 0.14
Nodes (24): _cache_key(), _prewarm(), _prewarm_source(), Path, _agreement(), best_flag(), characterize(), _determinism() (+16 more)
...
Cohesion: 0.18
Nodes (10): Architecture, Current evidence, Decision, Dual-model CI outcome, Measurements and retained tuning, Next acceptance run, Passing evidence, Production status (+2 more)

### Community 33 - "Gemma baseline"
Cohesion: 0.25
Nodes (7): Baseline conclusion, Gemma baseline, Isolation status, Proposition counts, Scope, Structured output, Untuned results

## Knowledge Gaps
- **121 isolated node(s):** `_GenerationDefaults`, `name`, `private`, `version`, `type` (+116 more)
...
- **Why does `Proposition` connect `main.py` to `test_resolve.py`, `embed`, `llm.py`, `extract.py`?**
