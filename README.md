...
flags, and which gaps you have explained again in review. Marking a card "still
shaky" is never stored. Nothing else is written, every row is readable only by its owner, and
